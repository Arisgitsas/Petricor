...
<head>
    ...
    <!-- Site Metas -->
    <title>Petricor - Βιολογικά καλλυντικά και φυτικά προϊόντα!</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    <li class="nav-item active"><a class="nav-link" href="stuPlatform.jsp">Home</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="UploadServlet">Upload</a></li>
                    <li class="nav-item"><a class="nav-link"><form action="index.jsp">
