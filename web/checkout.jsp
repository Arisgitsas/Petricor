...
<div class="main-top">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="login-box">
                    <select id class="selectpicker show-tick form-control" data-placeholder="Sign In">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="payment-icon">
                                    <ul>
                                        <li><img class="img-fluid" src="imagesshop/payment-icon/1.png" alt=""></li>
                                        <li><img class="img-fluid" src="imagesshop/payment-icon/2.png" alt=""></li>
                                        <li><img class="img-fluid" src="imagesshop/payment-icon/3.png" alt=""></li>
                                        <li><img class="img-fluid" src="imagesshop/payment-icon/5.png" alt=""></li>
                                        <li><img class="img-fluid" src="imagesshop/payment-icon/7.png" alt=""></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
